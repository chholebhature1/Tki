...
export function AppointmentCard({ appointment, showTherapist = true, showPatient = false }: AppointmentCardProps) {
  ...
  return (
    <Link
      ...
      className="flex flex-col gap-3 rounded-2xl border border-border bg-white p-5 transition-all hover:border-primary/30 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
    >
